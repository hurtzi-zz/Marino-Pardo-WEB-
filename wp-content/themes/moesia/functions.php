...
function moesia_nav_bar() {
	echo '<div class="top-bar">
			...
			echo '</nav>';
			echo '<div class="nav-lang" align="right">';
		    	echo '<a href="#qtranslate-2-chooser" title="Choose language"><img id="zoomLangua" src="http://www.marinopardo.com/wp-content/uploads/2015/07/language_icon.png" align="bottom" alt="Choose language"/></a>';
			echo '</div>';
