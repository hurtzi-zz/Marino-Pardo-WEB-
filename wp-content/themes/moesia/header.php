...
<body oncopy="alert('Opcion deshabilitada');return false" oncontextmenu="alert('Propiedad de © Marino Pardo');return false" onselectstart="return false" ondragstart="return false" <?php body_class(); ?>>
		...
		<?php if ( (get_theme_mod('moesia_banner') == 1 && is_front_page()) ||  (get_theme_mod('moesia_banner') != 1)) : ?>
			...
			<div class="welcome-info">
				...
				<?php if (get_theme_mod('header_btn_text') && get_theme_mod('header_btn_link')) : ?>
					<a href="<?php echo esc_url(get_theme_mod('header_btn_link')); ?>"><img id="zoom" src="http://www.marinopardo.com/wp-content/uploads/2015/07/Flecha_cabecera_blanco.png" alt="down arrow"></a>
				<?php endif; ?>
			</div>
		<?php endif; ?>
